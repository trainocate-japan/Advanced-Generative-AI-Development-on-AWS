...
4. 作成したリソースはデモとして研修中に活用
5. 終了後は各モジュールのクリーンアップ手順に従ってリソースを削除

## デモの実施方法

各モジュールの `steps.md` には「デモでの見せ方」セクションがあります。研修中にデモとして見せる場合は：

1. **事前準備**: ハンズオン手順を一度実行し、動作確認済みの環境を準備
2. **デモ実行**: 「デモでの見せ方」セクションに従い、ポイントを絞って実演
3. **説明**: 各ステップで何が起きているかを受講者に説明
4. **質疑応答**: デモ後に受講者からの質問に回答
